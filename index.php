		...
		<div class="container">
			<div class="banner-bottom-top">
				<div class="col-md-6 banner-bottom-left">
					<div class="bnr-one">
						<div class="bnr-left">
							<h1><a href="servicios.php">mantenimiento y reparaci&oacute;n de celulares</a></h1>
							<p>xxxxxxx xxxxxxxx xxxxx xxxxxxxxxx xxxxx xxxxxxxxxxxxx xxxxxxxxxx</p>
							<div class="b-btn"> 
								<a href="servicios.php">CONOCER</a>
							</div>
						</div>
						<div class="bnr-right"> 
							<a href="servicios.php"><img src="productos/b-1.jpg" alt="" /></a>
						</div>
						<div class="clearfix"> </div>
					</div>
				</div>
				<div class="col-md-6 banner-bottom-right">
					<div class="bnr-two">
						<div class="bnr-left">
							<h2><a href="servicios.php">mantenimiento y reparaci&oacute;n de equipos de computo</a></h2>
							<p>xxxxxx xxxxxxxx xxxx xxxxxxxxxxxx xxxxxxxxx xxxxx xxxxxx xxxxxx</p>
							<div class="b-btn"> 
								<a href="servicios.php">CONOCER</a>
							</div>
						</div>
						<div class="bnr-right"> 
							<a href="servicios.php"><img src="productos/b-2.jpg" alt="" /></a>
						</div>
						<div class="clearfix"> </div>
					</div>
				</div>
		...
		<div class="container"> 
			<div class="product-one">
				...
				<?php 
						...
						$sql=("SELECT * FROM producto order by fecha_ingreso DESC LIMIT 8 ");
				...
				<div class="col-md-3 product-left"> 
					<div class="p-one simpleCart_shelfItem" style="height: 308px;">							
							<a onclick="verProducto(<?php echo $id; ?>)">
								<img src="productos/<?php echo $ruta; ?>" alt="" />
								<div class="mask">
									<span>Mostrar</span>
								</div>
							</a>
		...
		<div class="container"> 
			<div class="abt-shoe-main">
				<div class="col-md-4 abt-shoe-left">
					<div class="abt-one">
						<a href="productos.php"><img src="productos/abt-1.jpg" alt="" /></a>
						<h4><a href="productos.php">Audio</a></h4>
						<p>xxxxxxxxxxx xxxxxxxxxx xxxxxxxxxxxx xxxxxxxx xxxxxxxx xxxxxxxxxxxx xxxxxxxxx xxxxxxxxxx xxxxxxxxx xxx xxxxxxxxxx xxxxxxxxxx xxxxxxxxxxxx xxxx</p>
					</div>
				</div>
				<div class="col-md-4 abt-shoe-left">
					<div class="abt-one">
						<a href="productos.php"><img src="productos/abt-2.jpg" alt="" /></a>
						<h4><a href="productos.php">Video Juegos</a></h4>
						<p>xxxxxxxxxxx xxxxxxxxxx xxxxxxxxxxxx xxxxxxxx xxxxxxxx xxxxxxxxxxxx xxxxxxxxx xxxxxxxxxx xxxxxxxxx xxx xxxxxxxxxx xxxxxxxxxx xxxxxxxxxxxx xxxx</p>
					</div>
				</div>
				<div class="col-md-4 abt-shoe-left">
					<div class="abt-one">
						<a href="productos.php"><img src="productos/abt-3.jpg" alt="" /></a>
						<h4><a href="productos.php">Celulares</a></h4>
						<p>xxxxxxxxxxx xxxxxxxxxx xxxxxxxxxxxx xxxxxxxx xxxxxxxx xxxxxxxxxxxx xxxxxxxxx xxxxxxxxxx xxxxxxxxx xxx xxxxxxxxxx xxxxxxxxxx xxxxxxxxxxxx xxxx</p>
					</div>
				</div>
				<div class="clearfix"> </div>
